  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-md rounded-2xl border border-neutral-800 bg-[#141419] p-5 shadow-2xl"
      >
        ...
        <div className="flex items-center justify-end gap-2">
          ...
          <button
            onClick={onStart}
            disabled={!repo}
            className="inline-flex items-center gap-1.5 rounded-md bg-white px-3 py-2 text-sm font-medium text-black transition-colors hover:bg-neutral-200 disabled:cursor-not-allowed disabled:opacity-40"
          >
            Start import
