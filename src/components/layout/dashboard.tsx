  ...
  <BackgroundGradient />
      <div className="relative z-10 w-full max-w-3xl">
        <div className="relative mb-6 flex flex-col items-center px-4 text-center md:mb-7">
          <h1 className="text-primary-pulse flex items-center gap-1 text-2xl font-medium leading-tight opacity-100 transition-opacity duration-500 md:gap-0 md:text-3xl">
            <span className="min-h-6 pt-0.5 sm:min-h-7 md:min-h-8 md:pt-0">
              Ready to build, Mohamed?
            </span>
          </h1>
        </div>
