...
>
  ...
  <h1 className="relative z-10 text-primary-pulse flex items-center gap-1 text-2xl font-medium leading-tight opacity-100 transition-opacity duration-500 md:gap-0 md:text-3xl">
